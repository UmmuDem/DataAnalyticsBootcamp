...
Next I moved to python and scraped pages with the [urls](http://localhost:8888/edit/Documents/GitHub/DataAnalyticsBootcamp/Final-Project/Data/courseraUrls.csv) I obtained. In [this notebook], you can find code itself. I collected 1515 course data in the beginning. Then I decided to stick with the [courses in English](http://localhost:8888/edit/Documents/GitHub/DataAnalyticsBootcamp/Final-Project/Data/courses_in_english.csv) to avoid the noise which is created by the non-Latin alphetic languages. 
